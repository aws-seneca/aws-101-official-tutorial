...
import { ArrowRight, BookOpen, Layers, Server, Terminal } from 'lucide-react';

const sections = [
  {
    href: '/docs/web-server-and-rds',
    icon: Server,
    title: 'Lesson 1: Web server and RDS',
    body: "AWS's official tutorial: an EC2 server, an RDS PostgreSQL database, and a PHP page that saves to it.",
  },
  {
    href: '/docs/app-to-rds',
    icon: Terminal,
    title: 'Lesson 2: App to RDS',
  ...
  },
  {
    ...
    icon: BookOpen,
    title: 'Concepts',
    body: 'Study notes on the services behind the lessons: EC2, security groups and VPC, RDS, IAM, S3, and costs.',
  },
  {
  ...
  return (
    <main className="mx-auto flex w-full max-w-5xl flex-1 flex-col px-6 py-16 sm:py-24">
      ...
      <p className="mt-4 max-w-xl text-lg leading-relaxed text-pretty text-fd-muted-foreground">
        Hands-on lessons you do in your own AWS account, and the notes to go further: what each service does, and
        how real systems are put together.
      </p>
      <div className="mt-8 flex flex-wrap gap-3">
        ...
        >
          Start Lesson 1 <ArrowRight className="size-4" />
        </Link>
